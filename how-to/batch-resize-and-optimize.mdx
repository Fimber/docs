...
- If you edit this documentation repo, shell snippets in MDX are checked in CI; see [Snippet verification (CI)](/development#snippet-verification-ci).
