...
<CardGroup cols={2}>
  <Card title="Resize and crop syntax reference" icon="ruler-combined" href="/reference/geometry">
    Dimension strings for `-resize`, `-crop`, and `-extent`: `800x600>`, `50%`, `WxH!`, `^`, offsets, and modifier flags.
  </Card>
