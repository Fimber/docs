...
<CardGroup cols={2}>
  ...
  <Card title="Need common flags?" icon="sliders" href="/reference/common-options">
    Quick reference for `-strip`, `-quality`, `-auto-orient`, `-gravity`, `-background`, and `-composite` with one example each.
  </Card>
</CardGroup>
