...
sidebarTitle: Geometry Syntax Reference
...
- [Common options reference](/reference/common-options) for `-strip`, `-quality`, `-gravity`, `-background`, `-composite`, and related flags used together with geometry in real commands.
