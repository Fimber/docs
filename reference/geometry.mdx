...
**Two-axis percentages (`50%x25%`).** Covered in the base table above: width and height scale **independently**, so the picture stretches unless both percentages match.
