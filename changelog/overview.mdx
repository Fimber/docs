...
description: Weekly updates to ImageMagick — new features, improvements, and bug fixes.
---

Track what's new in ImageMagick. Each post summarizes the changes that shipped that week and what they mean for you.

<Update label="May 15, 2026" description="Week of May 11 – May 15, 2026">

## Bug fixes

- **HEIF: improved compatibility with older libheif versions.** The `ignore_sequence_editlist` decoder option is now used only when building against libheif 1.21 or newer, restoring builds and runtime behavior for users on earlier libheif releases. See the [HEIC/HEIF reference](/reference/common-options) for supported options.
